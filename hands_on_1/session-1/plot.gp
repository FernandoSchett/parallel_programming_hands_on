...
set output 'myTest.eps'
set style data lines

plot "teste.data" using 1:2 title "LAPACK"     ls 6 with linespoints,\
     "teste.data" using 1:3 title "Threads=2"  ls 2 with linespoints,\
     "teste.data" using 1:4 title "Threads=4"  ls 4 with linespoints,\
     "teste.data" using 1:6 title "Threads=8"  ls 5 with linespoints,\
     "teste.data" using 1:7 title "Threads=16" ls 1 with linespoints
